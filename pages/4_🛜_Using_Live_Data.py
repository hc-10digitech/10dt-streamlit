...
st.write(
    """This is a Streamlit app that reads data from the internet, and uses interactive elements to present it
...
header = {
    "User-Agent": "Mr Matheson's streamlit app for Yr 10 Digitech - geoff.matheson@education.vic.gov.au"
}
